...
gcc $OPT -I../src ../src/wk-{err,box,array,bus,v,str}.c free-test.c -o free-test
./free-test
echo "-----------------"

gcc $OPT -I../src ../src/wk-{err,box,list,cli}.c cli-test.c -o cli-test
./cli-test --foo  -ba "hello world" -nm 3 "i am free!"
echo "-----------------"

gcc $OPT -I../src ../src/wk-{err,box,list}.c list-test.c -o list-test
./list-test
echo "-----------------"

gcc $OPT -I../src ../src/wk-{err,box}.c box-test.c -o box-test
./box-test
echo "-----------------"

gcc $OPT -I../src ../src/wk-{err,array}.c array-test.c -o array-test
./array-test
echo "-----------------"

gcc $OPT -I../src ../src/wk-{err,box,array,bus,v,str}.c str-test.c -o str-test
./str-test
